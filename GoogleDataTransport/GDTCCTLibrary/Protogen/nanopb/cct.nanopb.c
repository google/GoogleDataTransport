...
const pb_field_t gdt_cct_MacClientInfo_fields[6] = {
    ...
    PB_FIELD(  4, BYTES   , OPTIONAL, POINTER , OTHER, gdt_cct_MacClientInfo, country, application_build, 0),
    PB_FIELD(  7, BYTES   , OPTIONAL, POINTER , OTHER, gdt_cct_MacClientInfo, application_bundle_id, country, 0),
    PB_LAST_FIELD
};
