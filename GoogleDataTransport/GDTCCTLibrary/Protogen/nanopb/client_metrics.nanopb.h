...
typedef struct _gdt_client_metrics_LogSourceMetrics {
    pb_callback_t log_source;
    pb_callback_t log_event_dropped;
...
typedef struct _gdt_client_metrics_ClientMetrics {
    ...
    pb_callback_t log_source_metrics;
...
#define gdt_client_metrics_ClientMetrics_init_default {gdt_client_metrics_TimeWindow_init_default, {{NULL}, NULL}, gdt_client_metrics_GlobalMetrics_init_default, {{NULL}, NULL}}
...
#define gdt_client_metrics_LogSourceMetrics_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
#define gdt_client_metrics_LogEventDropped_init_default {0, _gdt_client_metrics_LogEventDropped_Reason_MIN}
#define gdt_client_metrics_ClientMetrics_init_zero {gdt_client_metrics_TimeWindow_init_zero, {{NULL}, NULL}, gdt_client_metrics_GlobalMetrics_init_zero, {{NULL}, NULL}}
...
#define gdt_client_metrics_LogSourceMetrics_init_zero {{{NULL}, NULL}, {{NULL}, NULL}}
