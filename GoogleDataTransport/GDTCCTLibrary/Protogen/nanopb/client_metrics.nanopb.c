...
const pb_field_t gdt_client_metrics_ClientMetrics_fields[5] = {
    ...
    PB_FIELD(  2, MESSAGE , REPEATED, CALLBACK, OTHER, gdt_client_metrics_ClientMetrics, log_source_metrics, window, &gdt_client_metrics_LogSourceMetrics_fields),
    ...
    PB_FIELD(  4, BYTES   , SINGULAR, CALLBACK, OTHER, gdt_client_metrics_ClientMetrics, app_namespace, global_metrics, 0),
    PB_LAST_FIELD
};
...
const pb_field_t gdt_client_metrics_LogSourceMetrics_fields[3] = {
    PB_FIELD(  1, BYTES   , SINGULAR, CALLBACK, FIRST, gdt_client_metrics_LogSourceMetrics, log_source, log_source, 0),
    PB_FIELD(  2, MESSAGE , REPEATED, CALLBACK, OTHER, gdt_client_metrics_LogSourceMetrics, log_event_dropped, log_source, &gdt_client_metrics_LogEventDropped_fields),
    PB_LAST_FIELD
};
